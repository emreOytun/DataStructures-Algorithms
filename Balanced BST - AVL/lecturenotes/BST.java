...
public class BST<E extends Comparable<E>> extends BinaryTree<E> implements SearchTree<E> {
    ...
    protected E deleteReturned = null;
    ...
    public boolean add(E data) throws NullPointerException {
        ...
        add(data, root);
        ++size;
        return true; // Since i add duplicate elements, always return true. Otherwise, we have to keep a variable "addReturned."
    }
    ...
    private void add(E data, Node<E> curNode) {
        ...
        else /*if (data.compareTo(curNode.data) > 0)*/ {    // If we remove the comment here, there will not be duplicate elements.
